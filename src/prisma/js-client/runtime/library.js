...
var ne = (e, r) => () => (r || e((r = {exports: {}}).exports, r), r.exports), tr = (e, r) => {
    for (var t in r) Vt(e, t, {get: r[t], enumerable: !0})
}, _o = (e, r, t, n) => {
...
var A = (e, r, t) => (t = e != null ? xu(Tu(e)) : {}, _o(r || !e || !e.__esModule ? Vt(t, "default", {
    value: e,
    enumerable: !0
}) : t, e)), Ru = e => _o(Vt({}, "__esModule", {value: !0}), e);
var yi = ne((Fg, ss) => {
    "use strict";
...
var Pi = ne((ih, Jc) => {
    Jc.exports = {
        ...
        license: "Apache-2.0",
        author: "Tim Suchanek <suchanek@prisma.io>",
        prisma: {enginesVersion: "8047c96bbd92db98a2abc7c9323ce77c02c89dbc"},
        repository: {
            type: "git",
...
var Ds = ne((kh, Ne) => {
    "use strict";
    var Li = require("node:fs"), Fi = require("node:path"), op = require("node:os"), sp = require("node:crypto"),
        ap = Rs(), As = ap.version,
        lp = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
...
`), o = o.replace(/\\r/g, "\r")), r[i] = o
    ...
    function ks(e) {
        let r = null;
        if (e && e.path && e.path.length > 0) if (Array.isArray(e.path)) for (let t of e.path) Li.existsSync(t) && (r = t.endsWith(".vault") ? t : `${t}.vault`); else r = e.path.endsWith(".vault") ? e.path : `${e.path}.vault`; else r = Fi.resolve(process.cwd(), ".env.vault");
    ...
    function fp(e) {
        ...
        let i = [r];
        if (e && e.path) if (!Array.isArray(e.path)) i = [Cs(e.path)]; else {
            i = [];
            for (let l of e.path) i.push(Cs(l))
        }
        let o, s = {};
        for (let l of i) try {
            let u = B.parse(Li.readFileSync(l, {encoding: t}));
            B.populate(s, u, e)
        } catch (u) {
    ...
    function hp(e, r) {
        let t = Buffer.from(r.slice(-64), "hex"), n = Buffer.from(e, "base64"), i = n.subarray(0, 12),
            o = n.subarray(-16);
        n = n.subarray(12, -16);
        try {
            ...
            let a = s instanceof RangeError, l = s.message === "Invalid key length",
    ...
    var B = {configDotenv: fp, _configVault: mp, _parseVault: cp, config: gp, decrypt: hp, parse: up, populate: yp};
...
typeof process < "u" && ({
    ...
    NO_COLOR: $o,
    TERM: qo
} = process.env || {}, jo = process.stdout && process.stdout.isTTY);
...
var Cu = F(0, 0), W = F(1, 22), Ie = F(2, 22), Au = F(3, 23), Y = F(4, 24), Iu = F(7, 27), ku = F(8, 28), Du = F(9, 29),
    Ou = F(30, 39), ce = F(31, 39), qe = F(32, 39), ke = F(33, 39), nr = F(34, 39), _u = F(35, 39), De = F(36, 39),
    Nu = F(37, 39), Hr = F(90, 39), Lu = F(90, 39), Fu = F(40, 49), Mu = F(41, 49), $u = F(42, 49), qu = F(43, 49),
    ju = F(44, 49), Vu = F(45, 49), Bu = F(46, 49), Uu = F(47, 49);
var Gu = 100, Bo = ["green", "yellow", "blue", "magenta", "cyan", "red"], Kr = [], Uo = Date.now(), Qu = 0,
    ai = typeof process < "u" ? process.env : {};
...
function Wu(e) {
    let r = {
        color: Bo[Qu++ % Bo.length], enabled: Yr.enabled(e), namespace: e, log: Yr.log, extend: () => {
        }
    }, t = (...n) => {
        let {enabled: i, namespace: o, color: s, log: a} = r;
        if (n.length !== 0 && Kr.push([o, ...n]), Kr.length > Gu && Kr.shift(), Yr.enabled(o) || i) {
...
var Yo = A(require("node:child_process")), fi = A(require("node:fs/promises")), Kt = A(require("node:os"));
var Oe = Symbol.for("@ts-pattern/matcher"), Hu = Symbol.for("@ts-pattern/isVariadic"),
    Wt = "@ts-pattern/anonymous-select-key", ci = e => !!(e && typeof e == "object"), Qt = e => e && !!e[Oe],
    Ee = (e, r, t) => {
        if (Qt(e)) {
        ...
        if (ci(e)) {
            ...
            if (Array.isArray(e)) {
                ...
                if (o.length) {
                    ...
                    let s = r.slice(0, n.length), a = i.length === 0 ? [] : r.slice(-i.length),
...
var mi = class e {
    ...
    when(r, t) {
        if (this.state.matched) return this;
        let n = !!r(this.input);
        return new e(this.input, n ? {matched: !0, value: t(this.input, this.input)} : di)
    }
...
async function Zo() {
    ...
    let t = await tc(), n = await cc(),
        i = ic({arch: r, archFromUname: n, familyDistro: t.familyDistro}), {libssl: o} = await oc(i);
    return {platform: "linux", libssl: o, arch: r, archFromUname: n, ...t}
}

function rc(e) {
    let r = /^ID="?([^"\n]*)"?$/im, t = /^ID_LIKE="?([^"\n]*)"?$/im, n = r.exec(e),
        i = n && n[1] && n[1].toLowerCase() || "", o = t.exec(e), s = o && o[1] && o[1].toLowerCase() || "",
        a = hr({id: i, idLike: s}).with({id: "alpine"}, ({id: l}) => ({
            targetDistro: "musl",
            familyDistro: l,
            originalDistro: l
...
function ic(e) {
    return hr(e).with({familyDistro: "musl"}, () => (ee('Trying platform-specific paths for "alpine"'), ["/lib", "/usr/lib"])).with({familyDistro: "debian"}, ({archFromUname: r}) => (ee('Trying platform-specific paths for "debian" (and "ubuntu")'), [`/usr/lib/${r}-linux-gnu`, `/lib/${r}-linux-gnu`])).with({familyDistro: "rhel"}, () => (ee('Trying platform-specific paths for "rhel"'), ["/lib64", "/usr/lib64"])).otherwise(({
                                                                                                                                                                                                                                                                                                                                                                                                                                             familyDistro: r,
                                                                                                                                                                                                                                                                                                                                                                                                                                             arch: t,
                                                                                                                                                                                                                                                                                                                                                                                                                                             archFromUname: n
...
async function es() {
    if (ac(Ht)) return Promise.resolve({...Ht, memoized: !0});
    let e = await Zo(), r = lc(e);
    return Ht = {...e, binaryTarget: r}, {...Ht, memoized: !1}
}
...
var zt = globalThis.window?.document !== void 0, bg = globalThis.process?.versions?.node !== void 0,
    Eg = globalThis.process?.versions?.bun !== void 0, wg = globalThis.Deno?.version?.deno !== void 0,
    xg = globalThis.process?.versions?.electron !== void 0,
    vg = globalThis.navigator?.userAgent?.includes("jsdom") === !0,
    Pg = typeof WorkerGlobalScope < "u" && globalThis instanceof WorkerGlobalScope,
    Tg = typeof DedicatedWorkerGlobalScope < "u" && globalThis instanceof DedicatedWorkerGlobalScope,
    Sg = typeof SharedWorkerGlobalScope < "u" && globalThis instanceof SharedWorkerGlobalScope,
    Rg = typeof ServiceWorkerGlobalScope < "u" && globalThis instanceof ServiceWorkerGlobalScope,
    Zr = globalThis.navigator?.userAgentData?.platform,
    Cg = Zr === "macOS" || globalThis.navigator?.platform === "MacIntel" || globalThis.navigator?.userAgent?.includes(" Mac ") === !0 || globalThis.process?.platform === "darwin",
    Ag = Zr === "Windows" || globalThis.navigator?.platform === "Win32" || globalThis.process?.platform === "win32",
    Ig = Zr === "Linux" || globalThis.navigator?.platform?.startsWith("Linux") === !0 || globalThis.navigator?.userAgent?.includes(" Linux ") === !0 || globalThis.process?.platform === "linux",
    kg = Zr === "iOS" || globalThis.navigator?.platform === "MacIntel" && globalThis.navigator?.maxTouchPoints > 1 || /iPad|iPhone|iPod/.test(globalThis.navigator?.platform),
    Dg = Zr === "Android" || globalThis.navigator?.platform === "Android" || globalThis.navigator?.userAgent?.includes(" Android ") === !0 || globalThis.process?.platform === "android";
var k = "\x1B[", et = "\x1B]", yr = "\x07", Xr = ";", ts = !zt && Zt.default.env.TERM_PROGRAM === "Apple_Terminal",
    pc = !zt && Zt.default.platform === "win32", dc = zt ? () => {
    ...
    }, ns = (e = 1) => k + e + "A", gc = (e = 1) => k + e + "B", hc = (e = 1) => k + e + "C", yc = (e = 1) => k + e + "D",
    is = k + "G", bc = ts ? "\x1B7" : k + "s", Ec = ts ? "\x1B8" : k + "u", wc = k + "6n", xc = k + "E", vc = k + "F",
    Pc = k + "?25l", Tc = k + "?25h", Sc = e => {
        let r = "";
        for (let t = 0; t < e; t++) r += os + (t < e - 1 ? ns() : "");
        return e && (r += is), r
    }, Rc = k + "K", Cc = k + "1K", os = k + "2K", Ac = k + "J", Ic = k + "1J", hi = k + "2J", kc = k + "S", Dc = k + "T",
    Oc = "\x1Bc", _c = pc ? `${hi}${k}0f` : `${hi}${k}3J${k}H`, Nc = k + "?1049h", Lc = k + "?1049l", Fc = yr,
    Mc = (e, r) => [et, "8", Xr, Xr, r, yr, e, et, "8", Xr, Xr, yr].join(""), $c = (e, r = {}) => {
        ...
        setCwd: (e = dc()) => `${et}50;CurrentDir=${e}${yr}`, annotation(e, r = {}) {
...
var Hc = A(tn());
var M = A(require("node:path")), Kc = A(tn()), uh = N("prisma:engines");
...
var Ti = A(require("node:fs")), gs = gr("chmodPlusX");
...
function Ri(e) {
    let r = e.e, t = a => `Prisma cannot find the required \`${a}\` system library in your system`,
        n = r.message.includes("cannot open shared object file"),
        i = `Please refer to the documentation about Prisma's system requirements: ${xi("https://pris.ly/d/system-requirements")}`,
        o = `Unable to require(\`${Ie(e.id)}\`).`, s = hr({
            message: r.message,
            code: r.code
        }).with({code: "ENOENT"}, () => "File does not exist.").when(({message: a}) => n && a.includes("libz"), () => `${t("libz")}. Please install it and try again.`).when(({message: a}) => n && a.includes("libgcc_s"), () => `${t("libgcc_s")}. Please install it and try again.`).when(({message: a}) => n && a.includes("libssl"), () => {
...
var ki = class {
    ...
    toString() {
        let {config: r} = this, t = r.provider.fromEnvVar ? `env("${r.provider.fromEnvVar}")` : r.provider.value,
            n = JSON.parse(JSON.stringify({provider: t, binaryTargets: Yc(r.binaryTargets)}));
...
var $i = A(Ds()), an = A(require("node:fs"));
...
function _s(e) {
    if (Ep(e)) {
        ...
        let r = $i.default.config({path: e, debug: process.env.DOTENV_CONFIG_DEBUG ? !0 : void 0});
        return {
            dotenvResult: Os(r),
...
var vr = 9e15, Ke = 1e9, Vi = "0123456789abcdef",
    ...
    Bi = {precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -vr, maxE: vr, crypto: !1}, js, Le,
    w = !0, gn = "[DecimalError] ", He = gn + "Invalid argument: ", Vs = gn + "Precision limit exceeded",
    Bs = gn + "crypto unavailable", Us = "[object Decimal]", X = Math.floor, U = Math.pow,
    wp = /^0b([01]+(\.[01]*)?|\.[01]+)(p[+-]?\d+)?$/i, xp = /^0x([0-9a-f]+(\.[0-9a-f]*)?|\.[0-9a-f]+)(p[+-]?\d+)?$/i,
    vp = /^0o([0-7]+(\.[0-7]*)?|\.[0-7]+)(p[+-]?\d+)?$/i, Gs = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, fe = 1e7, E = 7,
    Pp = 9007199254740991, Tp = dn.length - 1, Ui = mn.length - 1, m = {toStringTag: Us};
...
m.minus = m.sub = function (e) {
    ...
    if (u = f.d, d = e.d, a = h.precision, l = h.rounding, !u[0] || !d[0]) {
        if (d[0]) e.s = -e.s; else if (u[0]) e = new h(f); else return new h(l === 3 ? -0 : 0);
        return w ? y(e, a, l) : e
    }
...
m.toFraction = function (e) {
    ...
    if (!h) return new g(f);
    if (u = t = new g(1), n = l = new g(0), r = new g(n), o = r.e = Qs(h) - f.e - 1, s = o % E, r.d[0] = U(10, s < 0 ? E + s : s), e == null) e = o > 0 ? r : u; else {
    ...
    return i = L(e.minus(t), n, 0, 1, 1), l = l.plus(i.times(u)), t = t.plus(i.times(n)), l.s = u.s = f.s, d = L(u, n, o, 1).minus(f).abs().cmp(L(l, t, o, 1).minus(f).abs()) < 1 ? [u, n] : [l, t], g.precision = c, w = !0, d
};
...
var L = function () {
    ...
    return function (n, i, o, s, a, l) {
        var u, c, p, d, f, h, g, S, P, R, b, D, me, ae, Jr, V, te, Ae, H, fr, jt = n.constructor,
            ni = n.s == i.s ? 1 : -1, K = n.d, _ = i.d;
        ...
        if (_[p] > (K[p] || 0) && c--, o == null ? (ae = o = jt.precision, s = jt.rounding) : a ? ae = o + (n.e - i.e) + 1 : ae = o, ae < 0) R.push(1), h = !0; else {
            if (ae = ae / f + 2 | 0, p = 0, H == 1) {
                ...
                do d = 0, u = r(_, b, H, D), u < 0 ? (me = b[0], H != D && (me = me * l + (b[1] || 0)), d = me / Ae | 0, d > 1 ? (d >= l && (d = l - 1), g = e(_, d, l), S = g.length, D = b.length, u = r(g, b, S, D), u == 1 && (d--, t(g, H < S ? fr : _, S, l))) : (d == 0 && (u = d = 1), g = _.slice()), S = g.length, S < D && g.unshift(0), t(b, g, D, l), u == -1 && (D = b.length, u = r(_, b, H, D), u < 1 && (d++, t(b, H < D ? fr : _, D, l))), D = b.length) : u === 0 && (d++, b = [0]), R[p++] = d, u && b[0] ? b[D++] = K[V] || 0 : (b = [K[V]], D = 1); while ((V++ < te || b[0] !== void 0) && ae--);
                h = b[0] !== void 0
            }
            R[0] || R.shift()
        }
        if (f == 1) P.e = c, js = h; else {
...
function y(e, r, t, n) {
    ...
    e:if (r != null) {
        ...
        if (o = r - i, o < 0) o += E, s = r, c = p[d = 0], l = c / U(10, i - s - 1) % 10 | 0; else if (d = Math.ceil((o + 1) / E), a = p.length, d >= a) if (n) {
            for (; a++ <= d;) p.push(0);
...
function Gi(e, r) {
    ...
    for (n = Math.log(U(2, p)) / Math.LN10 * 2 + 5 | 0, l += n, t = o = s = new d(1), d.precision = l; ;) {
        if (o = y(o.times(e), l, 1), t = t.times(++c), a = s.plus(L(o, t, l, 1)), J(a.d).slice(0, l) === J(s.d).slice(0, l)) {
            ...
            if (r == null) if (u < 3 && at(s.d, l - n, f, u)) d.precision = l += 10, t = o = a = new d(1), c = 0, u++; else return y(s, d.precision = h, f, w = !0); else return d.precision = h, s
        }
        s = a
    }
}
...
function Je(e, r) {
    var t, n, i, o, s, a, l, u, c, p, d, f = 1, h = 10, g = e, S = g.d, P = g.constructor, R = P.rounding,
        b = P.precision;
    ...
    for (p = g, l = s = g = L(g.minus(1), g.plus(1), c, 1), d = y(g.times(g), c, 1), i = 3; ;) {
        if (s = y(s.times(d), c, 1), u = l.plus(L(s, new P(i), c, 1)), J(u.d).slice(0, c) === J(l.d).slice(0, c)) if (l = l.times(2), o !== 0 && (l = l.plus(fn(P, c + 2, b).times(o + ""))), l = L(l, new P(f), c, 1), r == null) if (at(l.d, c - h, R, a)) P.precision = c += h, u = s = g = L(p.minus(1), p.plus(1), c, 1), d = y(g.times(g), c, 1), i = a = 1; else return y(l, P.precision = b, R, w = !0); else return P.precision = b, l;
        l = u, i += 2
    }
}
...
function Rp(e, r) {
    ...
    if (xp.test(r)) t = 16, r = r.toLowerCase(); else if (wp.test(r)) t = 2; else if (vp.test(r)) t = 8; else throw Error(He + r);
...
function Ks(e, r) {
    ...
    if (t = r.divToInt(i), t.isZero()) Le = n ? 3 : 2; else {
...
function Qi(e, r, t, n) {
    ...
    if (h ? (ie(t, 1, Ke), n === void 0 ? n = f.rounding : ie(n, 0, 8)) : (t = f.precision, n = f.rounding), !e.isFinite()) c = Hs(e); else {
...
function jp(e) {
    ...
    var r, t, n, i = e.defaults === !0,
        o = ["precision", 1, Ke, "rounding", 0, 8, "toExpNeg", -vr, 0, "toExpPos", 0, vr, "maxE", 0, vr, "minE", -vr, 0, "modulo", 0, 9];
    for (r = 0; r < o.length; r += 3) if (t = o[r], i && (this[t] = Bi[t]), (n = e[t]) !== void 0) if (X(n) === n && n >= o[r + 1] && n <= o[r + 2]) this[t] = n; else throw Error(He + t + ": " + n);
    if (t = "crypto", i && (this[t] = Bi[t]), (n = e[t]) !== void 0) if (n === !0 || n === !1 || n === 0 || n === 1) if (n) if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) this[t] = !0; else throw Error(Bs); else this[t] = !1; else throw Error(He + t + ": " + n);
    return this
}
...
function Ys(e) {
    ...
    if (i.prototype = m, i.ROUND_UP = 0, i.ROUND_DOWN = 1, i.ROUND_CEIL = 2, i.ROUND_FLOOR = 3, i.ROUND_HALF_UP = 4, i.ROUND_HALF_DOWN = 5, i.ROUND_HALF_EVEN = 6, i.ROUND_HALF_CEIL = 7, i.ROUND_HALF_FLOOR = 8, i.EUCLID = 9, i.config = i.set = jp, i.clone = Ys, i.isDecimal = qs, i.abs = Ap, i.acos = Ip, i.acosh = kp, i.add = Dp, i.asin = Op, i.asinh = _p, i.atan = Np, i.atanh = Lp, i.atan2 = Fp, i.cbrt = Mp, i.ceil = $p, i.clamp = qp, i.cos = Vp, i.cosh = Bp, i.div = Up, i.exp = Gp, i.floor = Qp, i.hypot = Wp, i.ln = Jp, i.log = Hp, i.log10 = Yp, i.log2 = Kp, i.max = zp, i.min = Zp, i.mod = Xp, i.mul = ed, i.pow = rd, i.random = td, i.round = nd, i.sign = id, i.sin = od, i.sinh = sd, i.sqrt = ad, i.sub = ld, i.sum = ud, i.tan = cd, i.tanh = pd, i.trunc = dd, e === void 0 && (e = {}), e && e.defaults !== !0) for (n = ["precision", "rounding", "toExpNeg", "toExpPos", "maxE", "minE", "modulo", "crypto"], r = 0; r < n.length;) e.hasOwnProperty(t = n[r++]) || (e[t] = this[t]);
    return i.config(e), i
}
...
function Wp() {
    ...
    for (w = !1, e = 0; e < arguments.length;) if (r = new this(arguments[e++]), r.d) t.d && (t = t.plus(r.times(r))); else {
...
function td(e) {
    ...
    if (e === void 0 ? e = this.precision : ie(e, 1, Ke), n = Math.ceil(e / E), this.crypto) if (crypto.getRandomValues) for (r = crypto.getRandomValues(new Uint32Array(n)); o < n;) i = r[o], i >= 429e7 ? r[o] = crypto.getRandomValues(new Uint32Array(1))[0] : a[o++] = i % 1e7; else if (crypto.randomBytes) {
        ...
        o = n / 4
    } else throw Error(Bs); else for (; o < n;) a[o++] = Math.random() * 1e7 | 0;
...
function Zs(e) {
    return {models: Wi(e.models), enums: Wi(e.enums), types: Wi(e.types)}
}
...
var ut = {};
tr(ut, {ModelAction: () => Cr, datamodelEnumToSchemaEnum: () => gd});
...
var wd = {red: ce, gray: Hr, dim: Ie, bold: W, underline: Y, highlightSource: e => e.highlight()},
    xd = {red: e => e, gray: e => e, dim: e => e, bold: e => e, underline: e => e, highlightSource: e => e};
...
function Ad(e) {
    ...
    for (let n of e) {
        ...
        o ? r.set(i, {
            ...n,
            argument: {...n.argument, typeNames: Id(o.argument.typeNames, n.argument.typeNames)}
        }) : r.set(i, n)
    }
...
var Tn = e => e, Sn = {bold: Tn, red: Tn, green: Tn, dim: Tn, enabled: !1},
    pa = {bold: W, red: ce, green: qe, dim: Ie, enabled: !0}, Ir = {
        write(e) {
            e.writeLine(",")
        }
    };
...
function Fd(e, r) {
    ...
    if (e.selectionPath.length === 0) r.arguments.addSuggestion(n); else {
...
function Wd(e, r) {
    let t = e.argumentPath[e.argumentPath.length - 1],
        n = r.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject(), i = [];
    if (n) {
...
function ha(e, r) {
    ...
    let o = i.getFieldValue("select")?.asObject(), s = i.getFieldValue("include")?.asObject(),
        a = i.getFieldValue("omit")?.asObject(), l = o?.getField(n);
    return o && l ? {
        parentKind: "select",
        parent: o,
        field: l,
        ...
        parent: s,
        fieldName: n
    } : (l = a?.getField(n), a && l ? {parentKind: "omit", field: l, parent: a, fieldName: n} : {
        parentKind: "unknown",
        fieldName: n
    }))
}
...
var An = {
    ...
    instances: {DbNull: new gt(Cn), JsonNull: new ht(Cn), AnyNull: new yt(Cn)}
};
...
function kn(e, r) {
    let t = r === "pretty" ? pa : Sn, n = e.renderAllMessages(t), i = new Ar(0, {colors: t}).write(e).toString();
...
function Dn({args: e, errors: r, errorFormat: t, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s}) {
    ...
    let {message: l, args: u} = kn(a, t),
        c = xn({message: l, callsite: n, originalMethod: i, showColors: t === "pretty", callArguments: u});
...
function Ln({
    ...
    return {modelName: e, action: rm[r], query: Et(t, p)}
}

function Et({select: e, include: r, ...t} = {}, n) {
    let i = t.omit;
    return delete t.omit, {arguments: ka(t, n), selection: tm(e, r, i, n)}
}
...
function cm(e) {
    return {datamodel: {models: eo(e.models), enums: eo(e.enums), types: eo(e.types)}}
}
...
var ro = new WeakMap, Fn = "$$PrismaTypedSql", wt = class {
    constructor(r, t) {
        ro.set(this, {sql: r, values: t}), Object.defineProperty(this, Fn, {value: Fn})
    }
...
var fu = A(Pi());
var gu = require("node:async_hooks"), hu = require("node:events"), yu = A(require("node:fs")),
    ti = A(require("node:path"));
var oe = class e {
    constructor(r, t) {
...
var $n = {enumerable: !0, configurable: !0, writable: !0};
...
function he(e, r) {
    let t = pm(r), n = new Set, i = new Proxy(e, {
        get(o, s) {
            ...
            let l = t.get(s);
            return l ? l.getPropertyDescriptor ? {...$n, ...l?.getPropertyDescriptor(s)} : $n : a
...
function $a(e) {
    if (e === void 0) return "";
    let r = _r(e);
    return new Ar(0, {colors: Sn}).write(r).toString()
}
...
function Ba(e, r) {
    return r({action: "count", unpacker: Im(e), argsMapper: Am})(e)
}
...
function Ua(e, r) {
    return r({action: "groupBy", unpacker: Dm(e), argsMapper: km})(e)
}
...
var Wa = e => Array.isArray(e) ? e : e.split("."), so = (e, r) => Wa(r).reduce((t, n) => t && t[n], e),
    Ja = (e, r, t) => Wa(r).reduceRight((n, i, o, s) => Object.assign({}, so(e, s.slice(0, o)), {[i]: n}), t);
...
function ao(e, r, t, n, i, o) {
    ...
    return l => {
        let u = Ze(e._errorFormat), c = Om(n, i), p = _m(l, o, c), d = t({dataPath: c, callsite: u})(p), f = Nm(e, r);
        return new Proxy(d, {
            get(h, g) {
                if (!f.includes(g)) return h[g];
                let P = [a[g].type, t, g], R = [c, p];
                return ao(e, ...P, ...R)
            }, ...qn([...f, ...Object.getOwnPropertyNames(d)])
        })
    }
}
...
var Lm = ["findUnique", "findUniqueOrThrow", "findFirst", "findFirstOrThrow", "create", "update", "upsert", "delete"],
    Fm = ["aggregate", "count", "groupBy"];

function lo(e, r) {
    let t = e._extensions.getAllModelExtensions(r) ?? {},
        n = [Mm(e, r), qm(e, r), xt(t), re("name", () => r), re("$name", () => r), re("$parent", () => e._appliedParent)];
    return he({}, n)
}
...
function Pt(e) {
    let r = [jm(e), Vm(e), re(uo, () => e), re("$parent", () => e._appliedParent)],
...
function Vn({visitor: e, result: r, args: t, runtimeDataModel: n, modelName: i}) {
    ...
    return t.include && Za({
        ...
        runtimeDataModel: n,
        visitor: e
    }), t.select && Za({includeOrSelect: t.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e}), o
}
...
function Za({includeOrSelect: e, result: r, parentModelName: t, runtimeDataModel: n, visitor: i}) {
    for (let [o, s] of Object.entries(e)) {
        ...
        r[o] = Vn({visitor: i, result: r[o], args: u, modelName: l.type, runtimeDataModel: n})
    }
}
...
var Gm = ["$connect", "$disconnect", "$on", "$transaction", "$use", "$extends"], el = Gm;
...
function sl(e, r, t, n) {
    ...
    return r[t]({
        ...
        }, __internalParams: e, query(s, a = e) {
            let l = a.customDataProxyFetch;
...
var Jm = () => globalThis.process?.release?.name === "node",
    Hm = () => !!globalThis.Bun || !!globalThis.process?.versions?.bun, Km = () => !!globalThis.Deno,
    Ym = () => typeof globalThis.Netlify == "object", zm = () => typeof globalThis.EdgeRuntime == "object",
    Zm = () => globalThis.navigator?.userAgent === "Cloudflare-Workers";

function Xm() {
    return [[Ym, "netlify"], [zm, "edge-light"], [Zm, "workerd"], [Km, "deno"], [Hm, "bun"], [Jm, "node"]].flatMap(t => t[0]() ? [t[1]] : []).at(0) ?? ""
}
...
var hl = A(require("node:fs")), St = A(require("node:path"));
...
function rf(e) {
    let {generator: r, generatorBinaryTargets: t, runtimeBinaryTarget: n} = e, i = {fromEnvVar: null, value: n},
        o = [...t, i];
    return Di({...r, binaryTargets: o})
}
...
async function yl(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some(d => d.native),
        l = !s.some(d => d.value === o), u = __filename.match(nf()) === null, c = {
            searchedLocations: i,
...
async function of(e, r) {
    let t = await ir(), n = [],
        i = [r.dirname, St.default.resolve(__dirname, ".."), r.generator?.output?.value ?? __dirname, St.default.resolve(__dirname, "../../../.prisma/client"), "/tmp/prisma-engines", r.cwd];
...
function Rl(e) {
    let r = {clientVersion: e.clientVersion}, t = Object.keys(e.inlineDatasources)[0], n = jr({
...
var go = "This request could not be understood by the server", Rt = class extends $ {
    ...
    constructor(r, t, n) {
        super(t || go, C(r, !1)), n && (this.code = n)
    }
};
...
var Ct = class extends $ {
    ...
    constructor(r, t) {
        super("Engine not started: healthcheck timeout", C(r, !0)), this.logs = t
    }
};
...
async function Ft(e, r) {
    if (e.ok) return;
    let t = {clientVersion: r, response: e}, n = await df(e);
...
async function gf(e, r) {
    ...
    if (o !== void 0 || n === "0.0.0" || n === "in-memory") {
        let [s] = t.split("-") ?? [], [a, l, u] = s.split("."), c = hf(`<=${a}.${l}.${u}`),
...
var Nl = 3, $t = N("prisma:client:dataproxyEngine"), qt = class {
    ...
    requestInternal({body: r, traceparent: t, customDataProxyFetch: n, interactiveTransaction: i}) {
        return this.withRetry({
            actionGerund: "querying", callback: async ({logHttpCall: o}) => {
                let s = i ? `${i.payload.endpoint}/graphql` : await this.url("graphql");
                o(s);
                let a = await dr(s, {
                    method: "POST",
                    headers: this.headerBuilder.build({traceparent: t, transactionId: i?.id}),
    ...
    async transaction(r, t, n) {
        ...
        return this.withRetry({
            actionGerund: `${i[r]} transaction`, callback: async ({logHttpCall: o}) => {
                if (r === "start") {
...
var vo = A(require("node:os")), Fl = A(require("node:path"));
...
`);
    ...
    return h(o) ? {ok: !1, diagnostics: {warnings: i, errors: o}, isUsing: f} : {
        ok: !0,
...
function Vl({copyEngine: e = !0}, r) {
    ...
    let s = Er(r.generator), a = s === "library", l = s === "binary", u = s === "client",
...
function Wl(e, r) {
    ...
    if (Sf(e)) return {prisma__type: "bytes", prisma__value: Buffer.from(e).toString("base64")};
    if (ArrayBuffer.isView(e)) {
        let {buffer: t, byteOffset: n, byteLength: i} = e;
...
var Co = ({clientMethod: e, activeProvider: r}) => t => {
    let n = "", i;
    if (Mn(t)) n = t.sql, i = {values: Qr(t.values), __prismaRawParameters__: !0}; else if (Array.isArray(t)) {
        let [o, ...s] = t;
    ...
    return i?.values ? Hl(`prisma.${e}(${n}, ${i.values})`) : Hl(`prisma.${e}(${n})`), {query: n, parameters: i}
}, Kl = {
...
var Df = N("prisma:client:request_handler"), ri = class {
    ...
    constructor(r, t) {
        this.logEmitter = t, this.client = r, this.dataloader = new Xn({
            batchLoader: ol(async ({
                                       requests: n,
                                       customDataProxyFetch: i
                                   }) => {
                let {transaction: o, otelParentCtx: s} = n[0], a = n.map(p => p.protocolQuery),
                    l = this.client._tracingHelper.getTraceParent(s), u = n.some(p => Do(p.protocolQuery.action));
            ...
            singleLoader: async n => {
                let i = n.transaction?.kind === "itx" ? nu(n.transaction) : void 0,
    ...
    unpack(r, t, n) {
        ...
        let i = Object.keys(r)[0], o = Object.values(r)[0], s = t.filter(u => u !== "select" && u !== "include"),
            a = so(o, s), l = i === "queryRaw" ? ei(a) : Tr(a);
        return n ? n(l) : l
    }
};
...
var su = ["datasources", "datasourceUrl", "errorFormat", "adapter", "log", "transactionOptions", "omit", "__internal"],
    au = ["pretty", "colorless", "minimal"], lu = ["info", "query", "warn", "error"], Lf = {
...
Expected string or undefined.`)
            ...
            for (let t of e) {
                ...
                if (t && typeof t == "object") for (let [i, o] of Object.entries(t)) if (n[i]) n[i](o); else throw new O(`Invalid property ${i} for "log" provided to PrismaClient constructor`)
            }
...
var qf = {requestArgsToMiddlewareArgs: e => e, middlewareArgsToRequestArgs: e => e},
...
function bu(e) {
    class r {
        ...
        async _transactionWithCallback({callback: n, options: i}) {
            let o = {traceparent: this._tracingHelper.getTraceParent()}, s = {
        ...
        _createItxClient(n) {
            return he(Pt(he(Ka(this), [re("_appliedParent", () => this._appliedParent._createItxClient(n)), re("_createPrismaPromise", () => Ao(n)), re(jf, () => n.id)])), [Fr(el)])
        }
        ...
        async _executeRequest({
            ...
            try {
                n = u ? u(n) : n;
                let h = {name: "serialize"}, g = this._tracingHelper.runInChildSpan(h, () => Ln({
                    modelName: l,
                    runtimeDataModel: this._runtimeDataModel,
                    action: a,
                    args: n,
...
function mu(e, r) {
    return Bf(e) ? [new oe(e, r), Kl] : [e, Yl]
}
